...
function renderDateSelect(from, to) {  
  // initialize the special date dropdown field
  $('#date-range-field span').text(from.getMonthName(false)+' '+from.getDate()+', '+from.getFullYear()+' - '+
                                  to.getMonthName(false)+' '+to.getDate()+', '+to.getFullYear());
